      ...
      <div class="info__row">
        ...
        <div class="info__column">
          <div class="info__item">
            ...
            <h2 class="info__title">{{dispalyClick !== '' ? flat[dispalyClick].title : flat[0].title}}
            </h2>
            <h3 class="info__subtitle">{{dispalyClick !== '' ? flat[dispalyClick].sub_title : flat[0].sub_title}}</h3>
            <p class="info__text">{{dispalyClick !== '' ? flat[dispalyClick].description : flat[0].description}}</p>

            <h3 class="info__subtitle" style="text-transform: none">Итого: {{dispalyClick !== '' ?
              flat[dispalyClick].price : flat[0].price}} р.</h3>
