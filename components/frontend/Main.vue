    ...
    <div class="container">
      <div class="main__column">
        ...
        <div class="main__text">
          ...
          Крснодарского края. От всей души делимся с Вами своими знаниями и трудолюбием. В каждом квадратном метре натянутого потолка нами потолка частичка нашей души!
        </div>
