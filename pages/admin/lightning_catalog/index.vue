  ...
  <div class="bg-grey">
    ...
    <v-row no-gutters>
      <v-col>
        ...
        создание категории</span>
      </v-col>
    </v-row>

    <AddCatalog :allCatalog="LIGHTNING_CATALOG" :slug="'lightning_catalog/'" :addingCategory="'ADD_LIGHTNING_CATEGORY'" @fetchCatalog="fetchCatalog"></AddCatalog>
