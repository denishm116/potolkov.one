<template>
  <div>
    <h1>Калькулятор стоимости натяжных потолков</h1>
    <div class="container">
      <v-breadcrumbs class="mt"
        :second="{name: 'Калькулятор стоимости натяжных потолков', to: false, active: false}"
      ></v-breadcrumbs>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Калькулятор стоимости натяжных потолков - Компания Господин Потолков предлагает натяжные потолки в Краснодаре от 260 р. с установкой!'
        },
        {
          'property': 'og:type',
          'content': 'website',
